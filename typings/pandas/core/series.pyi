...
class Series(IndexOpsMixin, NDFrame, Generic[S1]):
    ...
    @overload
    def __mul__(
        self, other: Union[Timedelta, Series[Timedelta]]
    ) -> Series[Timedelta]: ...
    @overload
    def __mul__(
        self: Series[Timedelta],
        other: Union[num, Series[bool], Series[int], Series[float]],
    ) -> Series[Timedelta]: ...
    ...
    @overload
    def __rsub__(
        self: Series[Timestamp], other: Union[Timestamp, Series[Timestamp]]
    ) -> Series[Timedelta]: ...
    @overload
    def __rsub__(
        self: Series[Timestamp], other: Union[Timedelta, Series[Timedelta]]
    ) -> Series[Timestamp]: ...
    @overload
    def __rsub__(
        self, other: Union[num, Timedelta, _ListLike, Series[S1]]
    ) -> Series: ...
    @overload
    def __rtruediv__(
        self: Series[Timedelta], other: Union[Timedelta, Series[Timedelta]]
    ) -> Series[float]: ...
    @overload
