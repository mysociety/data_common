...
class _LocIndexerFrame(_LocIndexer):
    ...
    def __getitem__(
        self,
        idx: Tuple[Union[StrLike, Tuple[StrLike, ...]], Callable, StrLike],
    ) -> Scalar: ...
    @overload
    def __getitem__(
        self,
    ...
    def __getitem__(
        self,
        idx: Tuple[Union[IndexType, MaskType], Callable, StrLike],
    ) -> Series: ...
    @overload
    def __getitem__(
        self,
        idx: Tuple[Tuple[slice, ...], Callable, StrLike],
    ) -> Series: ...
    @overload
    def __setitem__(
        self,
...
class DataFrame(NDFrame, OpsMixin):
    ...
    def pivot_table(
        self,
        values: Optional[Union[_str, Grouper, Sequence]] = ...,
